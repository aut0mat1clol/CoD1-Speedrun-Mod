...
priceRescue ( trigger )
{
	...
	// Здесь Прайс начинает говорить "Well, goodness me, Americans!..." ("noticed")
	level thread anim_single (guy, "noticed", undefined, node);

	// Завершаем уровень сразу как только он начинает говорить эту речь:
	thread endlevel();
