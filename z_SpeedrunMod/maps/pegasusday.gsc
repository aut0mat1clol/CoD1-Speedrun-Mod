...
{	
	...
	*/
	...
	{
		level.westDuration = 10;	//west end battle length in seconds, default 240 seconds
		level.westBaglimit = 12;	//player must kill this many in west battle
		level.stopwatch = 0;	//east end battle requisite length in minutes, replaces eastduration, must be at least 1.5 
