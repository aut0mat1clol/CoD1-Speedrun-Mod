...
//	level thread wait_notify (15.5, "go go go"); // 14.5
	level thread wait_notify (0.9, "go go go"); // 14.5
	level thread wait_notify (0.5, "sniper is talking"); // 14.5
...
//	sniper playsound (level.scrsound[sniper.animname]["fullbody61"]);
	level thread wait_notify (0.1, "sniper stops talking"); // 14.5
...
//	sniper.goalradius = node.radius;
	...
	level thread wait_notify (0.2, "sniper is talking"); // 14.5
